    ...
    <footer>
      <div className="container">
        <section className="footer text-center">
          <p className="title">Find an issue with this page? <a href="https://github.com/accusitivedev/abyditya/tree/main/src/components" target="_blank" rel="noreferrer">Fix it on Github 👈</a></p>
